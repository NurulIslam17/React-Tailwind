  ...
  return (
    <div className='max-w-[1240px] mx-auto py-5 md:grid grid-cols-2'>
        ...
        <div className='col-span-1 flex flex-col p-3'>
            ...
            <button type="button" class="w-[40%] md:w-[15%] font-bold py-1 px-5 mr-2 mb-2 text-sm text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Explore</button>
        </div>
    </div>
  )
}
